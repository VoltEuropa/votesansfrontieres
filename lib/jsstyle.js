...
(function (window, document, RSVP, rJS, XMLHttpRequest, DOMParser, URL,
  ...
  function renderPage(gadget, page_url, hash) {
    console.log("renderPage called page_url", page_url)
    ...
    function handleClick(evt) {
      ...
      return renderPage(gadget, target_element.href, link_url.hash)
        .push(function () {
          ...
          console.log("we failed with", error)
          alert("fail")
  ...
  rJS(window)
    ...
    .declareService(function () {
      ...
      if (!style_gadget_url) {
        ...
        // INFO: we don't need to fill a template so just listen for URL change
